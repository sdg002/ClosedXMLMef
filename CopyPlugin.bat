...
echo off
rem This will copy over the compiled output of data extractors/formatters to the central plugins folder
...
echo CONFIG=%CONFIG%
set EXEOUTPUT=%SOLNFOLDER%\Demo.ConsoleEXEFwk\Bin\%CONFIG%\net461
...
if not exist %EXEOUTPUT%  (
 ...
 set destination="%solnfolder%\Demo.ConsoleEXEFwk\bin\%config%\net461\plugins\%pluginname%"
